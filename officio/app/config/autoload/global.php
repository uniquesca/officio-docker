...
return [
    ...
    'session_config' => [
        // Also, check/update the session_timeout
        // Session cookie, so will be cleared (on browser close, but depends on browser settings)
        ...
        // SameSite attribute must be set on cookies containing session tokens
        'cookie_samesite' => 'Lax',
    ],
