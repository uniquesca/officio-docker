 ...
 * @param revert boolean if true - we should revert to pdf from html.
 * @constructor
 */
var Pdf2HtmlConverter = function (arrPdfIds, revert) {
    ...
    Pdf2HtmlConverter.superclass.constructor.call(this, {
            autoWidth: true,
            autoHeight: true,
            closable: false,
            plain: true,
    ...
    Ext.extend(Pdf2HtmlConverter, Ext.Window, {
        ...
        sendRequest: function (arrPdfIds, processedCount, totalCount) {
            ...
            var url = baseUrl + (wnd.revert ? '/forms/pdf2html-revert' : '/forms/pdf2html-convert');
