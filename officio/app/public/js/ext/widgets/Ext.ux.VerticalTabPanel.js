...
Ext.ux.VerticalTabPanel = Ext.extend(Ext.Panel,  {
    /**
    ...
    deferredRender : true,
    /**
     * @cfg {Number} tabWidth The initial width in pixels of each new tab (defaults to 275).
     */
    tabWidth : 275,
    /**
     ...
     */
    baseCls : 'x-tab-panel x-vr-tab-panel',
    /**
    ...
    initComponent : function(){
        this.frame = false;
        Ext.ux.VerticalTabPanel.superclass.initComponent.call(this);
        this.addEvents(
            /**
        ...
        if(!this.stack){
            this.stack = Ext.ux.VerticalTabPanel.AccessStack();
        }
        this.initItems();
    },
    ...
    onRender : function(ct, position){
        Ext.ux.VerticalTabPanel.superclass.onRender.call(this, ct, position);
        ...
        if(!this.itemTpl){
            ...
            tt.compile();
            Ext.ux.VerticalTabPanel.prototype.itemTpl = tt;
        }
    ...
    // private
    initEvents : function(){
        Ext.ux.VerticalTabPanel.superclass.initEvents.call(this);
        this.mon(this.strip, {
            scope: this,
    ...
    // private
    onAdd : function(c){
        Ext.ux.VerticalTabPanel.superclass.onAdd.call(this, c);
        if(this.rendered){
    ...
    onBeforeAdd : function(item){
        ...
        Ext.ux.VerticalTabPanel.superclass.onBeforeAdd.apply(this, arguments);
    ...
    onRemove : function(c){
        ...
        Ext.ux.VerticalTabPanel.superclass.onRemove.call(this, c);
        this.stack.remove(c);
        delete c.tabEl;
    ...
    onResize : function(){
        ...
        Ext.ux.VerticalTabPanel.superclass.onResize.apply(this, arguments);
    ...
    adjustBodySize : function() {
        ...
        if (Ext.isNumber(tw)) {
            var bd = this.body,
                bw = bd.up('.x-panel-body').getWidth(),
                pw = bw - tw;
    ...
    beforeDestroy : function() {
        ...
        this.activeTab = null;
        Ext.ux.VerticalTabPanel.superclass.beforeDestroy.apply(this);
    }
 ...
 * @method activate
 */
Ext.ux.VerticalTabPanel.prototype.activate = Ext.ux.VerticalTabPanel.prototype.setActiveTab;

// private utility class used by TabPanel
Ext.ux.VerticalTabPanel.AccessStack = function(){
    var items = [];
    return {
        add : function(item){
            items.push(item);
