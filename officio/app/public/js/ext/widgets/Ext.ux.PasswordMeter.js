...
Ext.extend(Ext.ux.PasswordMeter, Ext.form.TextField, {
        ...
        onRender: function(ct, position) {
            ...
            this.objMeter = ct.createChild({tag: "div", 'class': "strengthMeter", 'title' : 'Password strength meter'});

            this.objMeter.setWidth(elp.getWidth(true));

            // Fix: apply the same padding as for parent field
            this.objMeter.setStyle('padding', '0 3px');

            this.scoreBar = this.objMeter.createChild({tag: "div", 'class': "scoreBar", 'style': 'margin-left: -3px'});
        ...
        initEvents: function() {
            ...
            this.el.on('keyup', this.updateMeter, this, false);
        },
        /**
        ...
        updateMeter: function(e) {
            var score = 0;
            var p = (e.target) ? e.target.value : e;
