...
Ext.ux.form.HtmlEditor.IncludeAllPlugins = function() {
    return [new Ext.ux.form.HtmlEditor.ImageInsert(),
...
Ext.ux.form.HtmlEditor.ImageInsert = function(config) {
    ...
    this.imageInsertConfig = {
        ...
        popValue: config.popValue || 'http://'
    }
    
    this.imageInsert = function(){
        Ext.MessageBox.show({
            cls: 'insert-image-msg-box',
    ...
    function onRender() {
        if (!Ext.isSafari) {
            this.editor.tb.add({
                ...
                tooltip: {
                  title: 'Insert Image',
                  text: 'Insert Image in HTML Editor',
...
Ext.ux.form.HtmlEditor.Word = Ext.extend(Ext.util.Observable, {
    ...
    onRender: function() {
        ...
        this.cmp.getToolbar().add({
            ...
            overflowText: 'Clean doc/rtf file'
        });
