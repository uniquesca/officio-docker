...
!function () {
    ...
    function f() {
        ...
        cb = b[0], N = void 0 !== b[1] ? Number(b[1]) : N, Q = void 0 !== b[2] ? a(b[2]) : Q, _ = void 0 !== b[3] ? a(b[3]) : _, $ = void 0 !== b[4] ? Number(b[4]) : $, db = void 0 !== b[5] ? a(b[5]) : db, K = void 0 !== b[6] ? a(b[6]) : K, O = b[7], W = void 0 !== b[8] ? b[8] : W, M = b[9], P = b[10], ib = void 0 !== b[11] ? Number(b[11]) : ib, Z.enable = void 0 !== b[12] ? a(b[12]) : !1, fb = b[13]
    }
    ...
    function l() {
        ...
        }), k({eventType: "Device Orientation Change", eventName: "deviceorientation"}), k({
            eventType: "Transition End",
            eventNames: ["transitionend", "webkitTransitionEnd", "MSTransitionEnd", "oTransitionEnd", "otransitionend"]
        }), k({eventType: "Window Clicked", eventName: "click"}), "child" === fb && k({
    ...
    function m() {
        V !== W && (W in mb || (d(W + " is not a valid option for heightCalculationMethod."), W = "bodyScroll"), c('Height calculation method set to "' + W + '"'))
    }
    ...
    function p() {
        ...
        function e(a) {
            var c = a.getBoundingClientRect(), d = b();
            return {x: parseInt(c.left, 10) + parseInt(d.x, 10), y: parseInt(c.top, 10) + parseInt(d.y, 10)}
        }
        ...
        function f(a) {
            ...
            var d = a.split("#")[1] || "", f = decodeURIComponent(d), g = document.getElementById(f) || document.getElementsByName(f)[0];
        ...
        return Z.enable ? k() : c("In page linking not enabled"), {findTarget: f}
    }
    ...
    function u() {
        function a(a) {
            function b(a) {
                var b = /^\d+(px)?$/i;
                if (b.test(a))return parseInt(a, L);
    ...
    function E(a, b, d, e) {
        ...
        function i() {
            function a(a, b) {
                var c = Math.abs(a - b) <= ib;
                return !c
            }

            return n = void 0 !== d ? d : mb[W](), o = void 0 !== e ? e : D(), a(T, n) || Q && a(lb, o)
        }
    ...
    function F() {
        jb || (jb = !0, c("Trigger event lock on")), clearTimeout(kb), kb = setTimeout(function () {
            jb = !1, c("Trigger event lock off"), c("--")
        }, S)
    }

    function G(a) {
        T = mb[W](), lb = D(), I(T, lb, a)
    }
    ...
    function I(a, b, d, e, f) {
        function g() {
            void 0 === f ? f = gb : c("Message targetOrigin: " + f)
        }

        function h() {
            var g = a + ":" + b, h = cb + ":" + g + ":" + d + (void 0 !== e ? ":" + e : "");
            c("Sending message to host page (" + h + ")"), hb.postMessage(ab + h, f)
        }
    ...
    function J(a) {
        ...
        function f() {
            Y = a.data, hb = a.source, e(), U = !1, setTimeout(function () {
                X = !1
            }, S)
        }
        ...
        b() && (U === !1 ? "reset" === i() ? g() : "resize" === i() ? h() : a.data === Y || j() || d("Unexpected message (" + a.data + ")") : k() ? f() : d("Received message of type (" + i() + ") before initialization."))
    }

    var K = !0, L = 10, M = "", N = 0, O = "", P = "", Q = !1, R = {
        resize: 1,
        click: 1
    }, S = 128, T = 1, U = !0, V = "offset", W = V, X = !0, Y = "", Z = {}, $ = 32, _ = !1, ab = "[iFrameSizer]", bb = ab.length, cb = "", db = !1, eb = {
        max: 1,
        scroll: 1,
        bodyScroll: 1,
        documentElementScroll: 1
    }, fb = "parent", gb = "*", hb = window.parent, ib = 0, jb = !1, kb = null, lb = 1, mb = {
        offset: u,
        bodyOffset: u,
        bodyScroll: v,
