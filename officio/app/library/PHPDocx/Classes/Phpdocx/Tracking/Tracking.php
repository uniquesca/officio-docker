...
class Tracking
{
    ...
    public function addTrackingInsFirstR($xml)
    {
        ...
        if ($posRpr !== false) {
            $xml = substr_replace(
                $xml,
                '<w:ins w:author="' . CreateDocx::$trackingOptions['author'] . '" w:date="' . CreateDocx::$trackingOptions['date'] . '" w:id="' . CreateDocx::$trackingOptions['id'] . '">' . $tag,
                $posRpr,
                strlen($tag)
            );
    ...
    public function addTrackingInsR($xml)
    {
        ...
        $xmlDOM->loadXML(
            '<?xml version="1.0" encoding="UTF-8" ?><w:root xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:ve="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:wne="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:wp="http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing">' . $xml . '</w:root>'
        );
        if (PHP_VERSION_ID < 80000) {
