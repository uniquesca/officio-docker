    ...
    public function customize(DOMElement $wordElement, $options = array())
    {
        ...
        if ($options['tagType'] == 'paragraph' || $options['tagType'] == 'list' || $options['tagType'] == 'style') {
            ...
            if (isset($options['font'])) {
                if ($options['tagType'] == 'style') {
                    $this->generateWrapperContent($wordElement, 'rFonts', 'rPr', array('w:ascii' => $options['font'], 'w:hAnsi' => $options['font'], 'w:cs' => $options['font'], 'w:eastAsia' => $options['font']));
                } else {
                    $this->generateWrapperRprContent($wordElement, 'rFonts', 'rPr', array('w:ascii' => $options['font'], 'w:hAnsi' => $options['font'], 'w:cs' => $options['font'], 'w:eastAsia' => $options['font']));
                }
            }
        ...
        if ($options['tagType'] == 'section') {
            ...
            if (isset($options['space'])) {
                ...
                $this->insertAttributes($elements, array('w:space' => $options['space']));
            }
