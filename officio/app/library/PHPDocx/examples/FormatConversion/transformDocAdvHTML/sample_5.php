<?php
// generate a DOCX from a template replacing values using WordFragments and transform it to HTML
...
$docx->createDocx('example_transformDocAdvHTML_5.docx');

$transformHTMLPlugin = new Phpdocx\Transform\TransformDocAdvHTMLDefaultPlugin();

$transform = new Phpdocx\Transform\TransformDocAdvHTML('example_transformDocAdvHTML_5.docx');
