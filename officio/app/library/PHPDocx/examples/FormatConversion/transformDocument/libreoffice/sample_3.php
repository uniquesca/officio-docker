<?php
// generate a DOCX with a TOC and transform it to PDF using the conversion plugin based on LibreOffice updating the TOC. A macro must be installed (macros-libreoffice folder)
...
// check the macros-libreoffice folder available in the package to understand how to use LibreOffice macros
