<?php
// create a DOCX, add three text contents and clone the paragraph that contains Donec after the paragraph that contains Lorem
...
$docx->createDocx('example_cloneWordContent_1');