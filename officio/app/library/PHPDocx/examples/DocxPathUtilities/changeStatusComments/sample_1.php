<?php
// create a DOCX with comments and change the status of the comments
...
$docx->createDocx('example_changeStatusComments_1');

$docxPathUtilities = new Phpdocx\Utilities\DOCXPathUtilities();
$docxPathUtilities->changeStatusComments('example_changeStatusComments_1.docx', 'example_changeStatusComments_status_1.docx', array(), array(true, false));
