...
class UpdateFieldsMapping extends AbstractMigration
{
    ...
    public function down()
    {
        ...
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=135 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=135 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='emailAddress';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1093 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1093 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='english_test_scores';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1094 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1094 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='date_of_english_test';"
        );
