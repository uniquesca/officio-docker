...
class UpdateAutomaticReminderActions extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute(
            "INSERT INTO `automatic_reminder_action_types` (`automatic_reminder_action_type_id`, `automatic_reminder_action_type_internal_name`, `automatic_reminder_action_type_name`) VALUES ('2', 'create_task', 'Create task');"
        );
