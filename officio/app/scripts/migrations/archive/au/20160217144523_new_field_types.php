...
class NewFieldTypes extends AbstractMigration
{
    public function up()
    {
        ...
        // FOR CA
        // $this->execute("INSERT INTO `field_types` VALUES (26, 'visa_office', 'Visa Offices', 'N', 'N', 'N', 'N', 'N', 'case')");
        // $this->execute("INSERT INTO `field_types` VALUES (30, 'categories', 'Categories', 'N', 'N', 'N', 'N', 'N', 'case')");
