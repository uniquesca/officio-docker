...
class AddAutomaticReminderConditions extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute(
            "CREATE TABLE `automatic_reminder_condition_types` (
        ...
        $this->execute(
            "INSERT INTO `automatic_reminder_condition_types` (`automatic_reminder_condition_type_internal_id`, `automatic_reminder_condition_type_name`, `automatic_reminder_condition_type_order`) VALUES ('CLIENT_PROFILE', 'Based on a Date on the Client Profiles (i.e. Employers, or Individuals)', 0);"
        );
        $this->execute(
            "INSERT INTO `automatic_reminder_condition_types` (`automatic_reminder_condition_type_internal_id`, `automatic_reminder_condition_type_name`, `automatic_reminder_condition_type_order`) VALUES ('PROFILE', 'Based on a date on \"Case Details\"', 1);"
        );
        $this->execute(
            "INSERT INTO `automatic_reminder_condition_types` (`automatic_reminder_condition_type_internal_id`, `automatic_reminder_condition_type_name`, `automatic_reminder_condition_type_order`) VALUES ('FILESTATUS', 'Based on the Case Status on \"Case Details\"', 2);"
        );
        $this->execute(
            "INSERT INTO `automatic_reminder_condition_types` (`automatic_reminder_condition_type_internal_id`, `automatic_reminder_condition_type_name`, `automatic_reminder_condition_type_order`) VALUES ('BASED_ON_FIELD', 'Based on the field', 3);"
        );
        $this->execute(
            "INSERT INTO `automatic_reminder_condition_types` (`automatic_reminder_condition_type_internal_id`, `automatic_reminder_condition_type_name`, `automatic_reminder_condition_type_order`) VALUES ('CHANGED_FIELD', 'Changed field is', 4);"
        );
        $this->execute(
            "INSERT INTO `automatic_reminder_condition_types` (`automatic_reminder_condition_type_internal_id`, `automatic_reminder_condition_type_name`, `automatic_reminder_condition_type_order`) VALUES ('CASE_TYPE', 'Based on the case type', 5);"
        );

        $this->execute(
            "CREATE TABLE `automatic_reminder_conditions` (
