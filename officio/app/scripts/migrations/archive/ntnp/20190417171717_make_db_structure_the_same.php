...
class MakeDbStructureTheSame extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute(
            "ALTER TABLE `company_prospects_data_categories` ADD CONSTRAINT `FK_company_prospects_categories2` FOREIGN KEY (`prospect_category_id`) REFERENCES `company_prospects_categories` (`prospect_category_id`) ON UPDATE CASCADE ON DELETE CASCADE;"
        );
