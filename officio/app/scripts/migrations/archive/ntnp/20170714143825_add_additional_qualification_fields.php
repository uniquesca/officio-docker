...
class AddAdditionalQualificationFields extends AbstractMigration
{
    ...
    public function down()
    {
        ...
        $db->query("UPDATE company_questionnaires_fields SET q_field_order = q_field_order - 2 WHERE q_section_id = 5 && q_field_order > 9;");
        $db->query(
            "DELETE FROM company_questionnaires_fields WHERE q_field_unique_id IN('qf_education_additional_qualification', 'qf_education_additional_qualification_list', 'qf_education_spouse_additional_qualification', 'qf_education_spouse_additional_qualification_list');"
        );
