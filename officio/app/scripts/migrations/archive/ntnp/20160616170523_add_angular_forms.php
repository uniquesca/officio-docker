...
class AddAngularForms extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute(
            "ALTER TABLE `FormMap`
	                      ADD COLUMN `parent_member_type` INT(2) UNSIGNED NOT NULL DEFAULT '3' AFTER `form_map_type`;"
        );

        $this->execute(
            "ALTER TABLE `FormMap`
	                      ADD CONSTRAINT `FK_formMap_members_types` FOREIGN KEY (`parent_member_type`) REFERENCES `members_types` (`member_type_id`) ON UPDATE CASCADE ON DELETE CASCADE;"
        );
    ...
    public function down()
    {
        ...
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1034 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1034 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='lName';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1035 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1035 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='trading_name';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1036 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1036 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='australian_business_number';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1037 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1037 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='australian_company_number';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1038 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1038 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='australian_registered_body_number';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1039 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1039 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='australian_securities_exchange_code';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1040 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1040 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='operational_since';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1041 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1041 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='industry_type';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1042 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1042 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='emailAddress';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1043 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1043 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='nomination_occupation';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1044 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1044 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='fax_w';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1045 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1045 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='address_1';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1046 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1046 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='address_2';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1047 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1047 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='city';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1048 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1048 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='state';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1049 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1049 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='zip_code';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1050 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1050 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='country';"
        );
        $this->execute(
            "DELETE FROM `FormMap` WHERE  `FromFamilyMemberId`='main_applicant' AND `FromSynFieldId`=1051 AND `ToFamilyMemberId`='main_applicant' AND `ToSynFieldId`=1051 AND `ToProfileFamilyMemberId`='main_applicant' AND `ToProfileFieldId`='phone_main';"
        );
    }
}