...
class FixCountriesInFormsEiReg extends AbstractMigration
{
    ...
    public function up()
    {
        $fieldsToConvert = array(
            ...
            'BCPNP_Reg_ResCountry',
            'BCPNP_Reg_CredentialCountry',
        );
        ...
        try {
            ...
            if (empty($clients)) {
                ...
                foreach ($clients as $client) {
                    ...
                    if (empty($strError)) {
                        if ($do_rewrite) {
                            $output->writeln('Countries for EI registration #' . $client['fileNumber'] . ' are successfully fixed.');
                        }
                    } else {
                        $output->writeln('<error>Failed to check EI registration #' . $client['fileNumber'] . '. Reason: ' . $strError . '</error>');
                    }
