...
class ProspectsSpecificPoints extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute("ALTER TABLE `company_prospects`	ADD COLUMN `points_skilled_worker` INT(11) UNSIGNED NULL DEFAULT NULL AFTER `assessment`, ADD COLUMN `points_express_entry` INT(11) UNSIGNED NULL DEFAULT NULL AFTER `points_skilled_worker`;");
