...
class AddDesignatedAreaFieldsSection extends AbstractMigration
{
    public function up()
    {
        ...
        $db->query(" INSERT INTO `company_questionnaires_sections` (`q_section_id`, `q_section_step`, `q_section_order`) VALUES
            (13, 2, 11);
        ");
        $db->query("INSERT INTO `company_questionnaires_sections_templates` (`q_id`, `q_section_id`, `q_section_template_name`, `q_section_prospect_profile`)
