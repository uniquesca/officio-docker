...
class AddQnrFields extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute("INSERT INTO `company_questionnaires_fields_templates` (`q_id`, `q_field_id`, `q_field_label`, `q_field_prospect_profile_label`) SELECT q_id, $fieldId, 'Do you have at least $200,000 in Australian VC funding to commercialise an idea in Australia?', 'Do you have at least $200,000 in Australian VC funding to commercialise an idea in Australia?' FROM company_questionnaires;");
        $db->insert(
