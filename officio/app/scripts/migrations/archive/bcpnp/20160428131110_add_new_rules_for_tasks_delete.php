...
class AddNewRulesForTasksDelete extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute("INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `crm_only`, `rule_visible`, `rule_order`) VALUES (201, 200, 'tasks', 'Tasks', 'prospects-tasks-view', 0, 'N', 1, 21);");
