...
class UpdateManagePricing extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute(
            "INSERT INTO `pricing_categories` (`pricing_category_id`, `name`, `expiry_date`, `key_string`) VALUES
                            (1, 'General', NULL, ''),
                            (2, 'Promotion 1', '2016-12-30 00:00:00', 'Dec2016');"
        );

        $this->execute(
            "CREATE TABLE `pricing_category_details` (
        ...
        $this->execute(
            "INSERT INTO `pricing_category_details` (`pricing_category_detail_id`, `pricing_category_id`, `package_id`, `price_storage_1_gb_annual`, `price_storage_1_gb_monthly`, `price_license_user_annual`, `price_license_user_monthly`, `price_package_2_years`, `price_package_monthly`, `price_package_yearly`, `users_add_over_limit`, `user_included`, `free_storage`) VALUES
