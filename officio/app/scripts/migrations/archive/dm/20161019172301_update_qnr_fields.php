...
class UpdateQnrFields extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute(
            "INSERT INTO `company_questionnaires_fields_templates` (`q_id`, `q_field_id`, `q_field_label`, `q_field_prospect_profile_label`) SELECT q_id, $fieldId, 'Where did you hear about us?', 'Referred by:' FROM company_questionnaires;"
        );
        ...
        $fieldId = $db->lastInsertId('company_questionnaires_fields');
        $this->execute(
            "INSERT INTO `company_questionnaires_fields_templates` (`q_id`, `q_field_id`, `q_field_label`, `q_field_prospect_profile_label`) SELECT q_id, $fieldId, 'Date of initial interview:', 'Date of initial interview:' FROM company_questionnaires;"
        );
        ...
        $fieldId = $db->lastInsertId('company_questionnaires_fields');
        $this->execute(
            "INSERT INTO `company_questionnaires_fields_templates` (`q_id`, `q_field_id`, `q_field_label`, `q_field_prospect_profile_label`) SELECT q_id, $fieldId, 'Does any applicant have any criminal convictions?', 'Does any applicant have any criminal convictions?' FROM company_questionnaires;"
        );
        $db->insert(
        ...
        $fieldId = $db->lastInsertId('company_questionnaires_fields');
        $this->execute(
            "INSERT INTO `company_questionnaires_fields_templates` (`q_id`, `q_field_id`, `q_field_label`, `q_field_prospect_profile_label`) SELECT q_id, $fieldId, 'Does any applicant have health or care concerns?', 'Does any applicant have health or care concerns?' FROM company_questionnaires;"
        );
        $db->insert(
            'company_questionnaires_fields_options',
            array(
        ...
        $this->execute(
            "UPDATE `company_questionnaires_fields_templates` SET `q_field_label`='Have you taken an English test in last 36 months?' WHERE  `q_field_id`=33 AND q_field_label = 'Have you taken an IELTS test in last 36 months?';"
        );
        ...
        $this->execute(
            "UPDATE `company_questionnaires_fields_templates` SET `q_field_label`='Has your partner/spouse taken an English test in last 36 months?' WHERE  `q_field_id`=58 AND q_field_label = 'Has your partner/spouse taken an IELTS test in last 36 months?';"
        );
        ...
        $this->execute(
            "INSERT INTO `company_questionnaires_fields_options_templates` (`q_id`, `q_field_option_id`, `q_field_option_label`, `q_field_option_visible`) SELECT q_id, $fieldOptionIELTSId, 'IELTS', 'Y' FROM company_questionnaires;"
        );
        $db->insert(
            'company_questionnaires_fields_options',
            array(
        ...
        $fieldOptionId = $db->lastInsertId('company_questionnaires_fields_options');
        $this->execute(
            "INSERT INTO `company_questionnaires_fields_options_templates` (`q_id`, `q_field_option_id`, `q_field_option_label`, `q_field_option_visible`) SELECT q_id, $fieldOptionId, 'TOEFL iBT', 'Y' FROM company_questionnaires;"
        );
        $db->insert(
            'company_questionnaires_fields_options',
            array(
    ...
    public function down()
    {
        ...
        $this->execute(
            "DELETE FROM company_questionnaires_fields WHERE q_field_unique_id IN ('qf_language_spouse_type_of_test', 'qf_language_type_of_test', 'qf_further_information', 'qf_applicant_health_or_care_concerns', 'qf_applicant_have_criminal_convictions', 'qf_initial_interview_date', 'qf_referred_by')"
        );
        ...
        $this->execute(
            "UPDATE `company_questionnaires_fields_templates` SET `q_field_label`='Has your partner/spouse taken an IELTS test in last 36 months?' WHERE  `q_field_id`=58 AND q_field_label = 'Has your partner/spouse taken an English test in last 36 months?';"
        );
        ...
        $this->execute(
            "UPDATE `company_questionnaires_fields_templates` SET `q_field_label`='Have you taken an IELTS test in last 36 months?' WHERE  `q_field_id`=33 AND q_field_label = 'Have you taken an English test in last 36 months?';"
        );
