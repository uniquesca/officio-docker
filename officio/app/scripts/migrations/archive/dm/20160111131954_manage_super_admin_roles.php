...
class ManageSuperAdminRoles extends AbstractMigration
{
    public function up()
    {
        $this->execute("INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `rule_visible`) VALUES (2211, 4, 'superadmin', 'Manage Super Admin Roles', 'manage-superadmin-roles', 1);");
