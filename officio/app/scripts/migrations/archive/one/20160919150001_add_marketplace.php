...
class AddMarketplace extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute("INSERT INTO `admin_navigation` (`navigation_id`, `section_id`, `resource_id`, `action`, `rule_check_id`, `title`, `order_id`, `status`) VALUES (NULL, 4, 'marketplace', NULL, 'manage-marketplace', 'Marketplace Profiles', 23, 1);");
