...
class RenameLanguageOptions extends AbstractMigration
{
    ...
    public function down()
    {
        ...
        $db->query("UPDATE company_questionnaires_fields_options_templates SET q_field_option_label = 'Advanced/Native Proficiency' WHERE q_field_option_label = 'Advanced/Native Proficiency (NCLC 9+)' OR q_field_option_label = 'Advanced/Native Proficiency (CLB 9+)';");
