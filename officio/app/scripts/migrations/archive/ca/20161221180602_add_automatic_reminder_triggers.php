...
class AddAutomaticReminderTriggers extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute("CREATE TABLE `automatic_reminder_trigger_types` (
        ...
        $this->execute("INSERT INTO `automatic_reminder_trigger_types` (`automatic_reminder_trigger_type_id`, `automatic_reminder_trigger_type_internal_id`, `automatic_reminder_trigger_type_name`, `automatic_reminder_trigger_type_order`) VALUES (1, 'payment_due', 'Payment is due from Retainer Schedule', 1);");
        $this->execute("INSERT INTO `automatic_reminder_trigger_types` (`automatic_reminder_trigger_type_id`, `automatic_reminder_trigger_type_internal_id`, `automatic_reminder_trigger_type_name`, `automatic_reminder_trigger_type_order`) VALUES (2, 'case_mark_form_as_complete', 'Case mark a form as Complete', 2);");
        $this->execute("INSERT INTO `automatic_reminder_trigger_types` (`automatic_reminder_trigger_type_id`, `automatic_reminder_trigger_type_internal_id`, `automatic_reminder_trigger_type_name`, `automatic_reminder_trigger_type_order`) VALUES (3, 'case_uploads_documents', 'Case uploads Documents', 3);");
        $this->execute("INSERT INTO `automatic_reminder_trigger_types` (`automatic_reminder_trigger_type_id`, `automatic_reminder_trigger_type_internal_id`, `automatic_reminder_trigger_type_name`, `automatic_reminder_trigger_type_order`) VALUES (4, 'client_or_case_profile_update', 'Client/Case profile update', 0);");
        $this->execute("INSERT INTO `automatic_reminder_trigger_types` (`automatic_reminder_trigger_type_id`, `automatic_reminder_trigger_type_internal_id`, `automatic_reminder_trigger_type_name`, `automatic_reminder_trigger_type_order`) VALUES (5, 'case_file_status_changed', 'Case File Status changed', 4);");
        $this->execute("INSERT INTO `automatic_reminder_trigger_types` (`automatic_reminder_trigger_type_id`, `automatic_reminder_trigger_type_internal_id`, `automatic_reminder_trigger_type_name`, `automatic_reminder_trigger_type_order`) VALUES (6, 'case_creation', 'Case creation', 5);");
        $this->execute("INSERT INTO `automatic_reminder_trigger_types` (`automatic_reminder_trigger_type_id`, `automatic_reminder_trigger_type_internal_id`, `automatic_reminder_trigger_type_name`, `automatic_reminder_trigger_type_order`) VALUES (7, 'field_value_change', 'Field value change', 6);");
        $this->execute("INSERT INTO `automatic_reminder_trigger_types` (`automatic_reminder_trigger_type_id`, `automatic_reminder_trigger_type_internal_id`, `automatic_reminder_trigger_type_name`, `automatic_reminder_trigger_type_order`) VALUES (8, 'cron', 'Cron', 7);");

        $this->execute("CREATE TABLE `automatic_reminder_triggers` (
        ...
        foreach ($arrReminders as $arrReminderInfo) {
            ...
            foreach ($arrTriggerTypes as $triggerTypeId) {
                $this->table('automatic_reminder_triggers')
                    ->insert([
                        [
    ...
    public function down()
    {
        ...
        $arrReminderTriggers = $statement->fetchAll('assoc');
        foreach ($arrReminderTriggers as $arrReminderTriggerInfo) {
            ...
            $this->getQueryBuilder()
                ...
                ->set(array('trigger' => $intTriggerType))
                ->where(
                    [
                        'automatic_reminder_id' => (int)$arrReminderTriggerInfo['automatic_reminder_id']
                    ]
                )
                ->execute();
        }
