...
class ManageSuperAdminRoles extends AbstractMigration
{
    ...
    {
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `rule_visible`) VALUES (2211, 4, 'superadmin', 'Manage Super Admin Roles', 'manage-superadmin-roles', 1, 1);"
        );
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `rule_visible`) VALUES (2212, 2211, 'superadmin', 'Add Super Admin Role', 'manage-superadmin-roles-add', 1, 1);"
        );
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `rule_visible`) VALUES (2213, 2211, 'superadmin', 'Edit Super Admin Role', 'manage-superadmin-roles-edit', 1, 1);"
        );
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `rule_visible`) VALUES (2214, 2211, 'superadmin', 'delete Super Admin Role', 'manage-superadmin-roles-delete', 1, 1);"
        );
