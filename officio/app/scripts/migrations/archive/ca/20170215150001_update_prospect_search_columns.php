    ...
    private function getFields($booToHide = true)
    {
        if ($booToHide) {
            $arrFields = array(
                ...
                'qf_children_age_5',
                'qf_children_age_6',
                'qf_education_diploma_name',
                'qf_education_spouse_diploma_name',
                'qf_education_area_of_studies',
                'qf_education_spouse_area_of_studies',
                'qf_education_institute_type',
                'qf_education_spouse_institute_type',
                'qf_study_previously_studied',
                'qf_education_spouse_previously_studied',
                'qf_education_bachelor_degree_name',
                'qf_education_spouse_bachelor_degree_name',
                ...
                'qf_cat_net_assets',
                'qf_visit_previously_visited',
                'qf_visit_previously_applied',
                'qf_visit_preferred_destination',
                'qf_visit_previously_submitted_express_entry',
