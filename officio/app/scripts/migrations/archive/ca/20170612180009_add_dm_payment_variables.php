...
class AddDmPaymentVariables extends AbstractMigration
{
    public function up()
    {
        $this->execute("ALTER TABLE `u_variable` CHANGE COLUMN `name` `name` VARCHAR(255) NOT NULL DEFAULT '' FIRST;");
    ...
    public function down()
    {
        ...
        $this->execute("ALTER TABLE `u_variable` CHANGE COLUMN `name` `name` VARCHAR(48) NOT NULL DEFAULT '' FIRST;");
    }
}
