...
class AddNewQnrFields extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute(
            "INSERT INTO `company_prospects_data` (`prospect_id`, `q_field_id`, `q_value`)
        ...
        $this->execute(
            'ALTER TABLE `company_questionnaires_fields_options` ADD CONSTRAINT `FK_company_questionnaires_fields_options_1` FOREIGN KEY (`q_field_id`) REFERENCES `company_questionnaires_fields` (`q_field_id`) ON UPDATE CASCADE ON DELETE CASCADE;'
        );
