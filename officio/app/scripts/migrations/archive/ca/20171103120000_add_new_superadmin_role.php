...
class AddNewSuperadminRole extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `crm_only`, `rule_visible`, `rule_order`) VALUES (1360, 1040, 'superadmin', 'Quick Search', 'run-companies-search', 1, 'N', 1, 0);"
        );
        ...
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `crm_only`, `rule_visible`, `rule_order`) VALUES (1390, 4, 'superadmin', 'View Superadmin Tab', 'admin-tab-view', 1, 'N', 1, 0);"
        );
        ...
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`,`rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `rule_visible`,`rule_order`) VALUES (1046, 1040, 'superadmin','Change Company Status','manage-company-change-status',1,1,4);"
        );
        ...
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `crm_only`, `rule_visible`, `rule_order`) VALUES (1047, 1040, 'superadmin','View Companies List','manage-company-view-companies',1,'N',1,5)"
        );
        ...
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `crm_only`, `rule_visible`, `rule_order`) VALUES (1048, 1040, 'superadmin', 'Manage Company Email', 'manage-company-email', 1, 'N', 1, 0)"
        );
        ...
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `crm_only`, `rule_visible`, `rule_order`) VALUES (1049, 1042, 'superadmin', 'Edit Company Extra Details', 'edit-company-extra-details', 0, 'N', 1, 0)"
        );
        ...
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `crm_only`, `rule_visible`, `rule_order`) VALUES (1014, 1012, 'superadmin', 'Edit Roles ', 'admin-roles-edit', 0, 'N', 1, 0)"
        );
        ...
        $this->execute(
            "INSERT INTO `acl_rules` (`rule_id`, `rule_parent_id`, `module_id`, `rule_description`, `rule_check_id`, `superadmin_only`, `crm_only`, `rule_visible`, `rule_order`) VALUES (1420, 1040, 'superadmin', 'Manage Company Packages', 'manage-company-packages', 1, 'N', 1, 4), (1421, 1420, 'superadmin', 'Manage Company Packages Extra Details', 'manage-company-packages-extra-details', 1, 'N', 1, 0);"
        );
        $this->execute(
            "INSERT INTO `acl_rule_details` (`rule_id`, `module_id`, `resource_id`, `resource_privilege`, `rule_allow`) VALUES (1420, 'superadmin', 'manage-company', 'save-packages', 1), (1420, 'superadmin', 'manage-company-packages', 'index', 1), (1421, 'superadmin', 'manage-company-packages', 'edit-extra-details', 1);"
        );
