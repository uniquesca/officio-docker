...
class AddStudyAdmissionField extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute(
            "INSERT INTO `company_questionnaires_fields_templates` (`q_id`, `q_field_id`, `q_field_label`, `q_field_prospect_profile_label`) SELECT q_id, $fieldId, 'Do you have admission from a school or post-secondary institution in Canada?', 'Do you have admission from a school or post-secondary institution in Canada?' FROM company_questionnaires;"
        );
