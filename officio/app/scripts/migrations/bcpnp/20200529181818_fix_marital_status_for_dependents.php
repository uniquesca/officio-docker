...
class FixMaritalStatusForDependents extends AbstractMigration
{
    public function up()
    {
        $this->execute("ALTER TABLE `client_form_dependents` CHANGE COLUMN `marital_status` `marital_status` ENUM('single','married','engaged','widowed','separated','divorced') NULL DEFAULT NULL AFTER `profession`;");
    ...
    public function down()
    {
        ...
        $this->execute("ALTER TABLE `client_form_dependents` CHANGE COLUMN `marital_status` `marital_status` ENUM('single','married','divorced','widowed') NULL DEFAULT NULL AFTER `profession`;");
    }
}