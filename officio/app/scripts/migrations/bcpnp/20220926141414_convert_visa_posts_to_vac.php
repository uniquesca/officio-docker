...
class ConvertVisaPostsToVac extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute("CREATE TABLE `client_vac` (
            ...
            `client_vac_country` CHAR(255) NULL DEFAULT NULL,
            `client_vac_city` CHAR(255) NULL DEFAULT NULL,
            `client_vac_link` CHAR(255) NULL DEFAULT NULL,
            `client_vac_order` TINYINT(3) UNSIGNED NOT NULL DEFAULT '0',
            `client_vac_deleted` ENUM('Y','N') NOT NULL DEFAULT 'N',
    ...
    {
        $this->execute("UPDATE `client_form_fields` SET `label`='Visa Posts', `type`=3 WHERE company_field_id = 'immigration_office'");
