...
class FixCompanyAdmin extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute("ALTER TABLE `company_prospects` DROP INDEX `company_id`;");
        $this->execute("ALTER TABLE `company_prospects` ADD INDEX `status` (`status`);");
    }
    ...
    public function down()
    {
        ...
        $this->execute("ALTER TABLE `company_prospects` ADD INDEX `company_id` (`company_id`);");
        $this->execute("ALTER TABLE `company_prospects` DROP INDEX `status`;");
    }
}