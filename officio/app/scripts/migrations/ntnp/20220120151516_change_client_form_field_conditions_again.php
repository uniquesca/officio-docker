...
class ChangeClientFormFieldConditionsAgain extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute("ALTER TABLE `client_form_field_conditions` CHANGE COLUMN `field_option_value` `field_option_value` TEXT NULL COLLATE 'utf8_general_ci' AFTER `field_id`;");
    }
    ...
    public function down()
    {
        ...
        $this->execute("ALTER TABLE `client_form_field_conditions` CHANGE COLUMN `field_option_value` `field_option_value` VARCHAR(128) NULL DEFAULT NULL COLLATE 'utf8_general_ci' AFTER `field_option_client_status_id`;");
    }
}
